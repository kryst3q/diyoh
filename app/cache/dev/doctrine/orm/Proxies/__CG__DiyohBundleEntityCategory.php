 ...
 */
class Category extends \DiyohBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DiyohBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'DiyohBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'DiyohBundle\\Entity\\Category' . "\0" . 'projects', '' . "\0" . 'DiyohBundle\\Entity\\Category' . "\0" . 'tools');
        }
