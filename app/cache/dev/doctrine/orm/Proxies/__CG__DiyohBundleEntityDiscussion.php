 ...
 */
class Discussion extends \DiyohBundle\Entity\Discussion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DiyohBundle\\Entity\\Discussion' . "\0" . 'id', '' . "\0" . 'DiyohBundle\\Entity\\Discussion' . "\0" . 'title', '' . "\0" . 'DiyohBundle\\Entity\\Discussion' . "\0" . 'projectId', '' . "\0" . 'DiyohBundle\\Entity\\Discussion' . "\0" . 'authorId', '' . "\0" . 'DiyohBundle\\Entity\\Discussion' . "\0" . 'startDatetime');
        }
    ...
    public function setAuthorrId($authorId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAuthorrId', array($authorId));

        return parent::setAuthorrId($authorId);
    }
